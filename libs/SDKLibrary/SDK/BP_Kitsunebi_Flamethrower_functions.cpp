...
// Parameters:
// class UNiagaraComponent*                Param_FlameEffect                                      (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void ABP_Kitsunebi_Flamethrower_C::BeginShoot(class UNiagaraComponent** Param_FlameEffect)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_FlameEffect != nullptr)
		*Param_FlameEffect = Parms.Param_FlameEffect;
}
