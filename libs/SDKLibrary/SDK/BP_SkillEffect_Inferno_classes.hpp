...
public:
	...
	uint8                                         Pad_5763[0x4];                                     // 0x03CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5764[0x3];                                     // 0x0409(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Index_BP_SkillEffect_Inferno_C;                    // 0x040C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void GetInsertIndex(const struct FVector& Location, int32* Param_Index, bool* IsInside);
...
static_assert(offsetof(ABP_SkillEffect_Inferno_C, Index_BP_SkillEffect_Inferno_C) == 0x00040C, "Member 'ABP_SkillEffect_Inferno_C::Index_BP_SkillEffect_Inferno_C' has a wrong offset!");
