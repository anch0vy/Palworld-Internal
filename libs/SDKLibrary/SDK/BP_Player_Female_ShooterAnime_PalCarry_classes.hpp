...
static_assert(sizeof(UBP_Player_Female_ShooterAnime_PalCarry_C) == 0x000298, "Wrong size on UBP_Player_Female_ShooterAnime_PalCarry_C");
static_assert(offsetof(UBP_Player_Female_ShooterAnime_PalCarry_C, Ride_Fire_Front) == 0x000280, "Member 'UBP_Player_Female_ShooterAnime_PalCarry_C::Ride_Fire_Front' has a wrong offset!");
static_assert(offsetof(UBP_Player_Female_ShooterAnime_PalCarry_C, Ride_Fire_Right) == 0x000288, "Member 'UBP_Player_Female_ShooterAnime_PalCarry_C::Ride_Fire_Right' has a wrong offset!");
static_assert(offsetof(UBP_Player_Female_ShooterAnime_PalCarry_C, Ride_Fire_Left) == 0x000290, "Member 'UBP_Player_Female_ShooterAnime_PalCarry_C::Ride_Fire_Left' has a wrong offset!");
