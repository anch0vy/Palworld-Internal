...
public:
	...
	uint8                                         Pad_261F[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0008(0x0040)(IsPlainOldData, NoDestructor)
	float                                         K2Node_Event_InDeltaTime;                          // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2620[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2621[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2622[0x3];                                     // 0x02D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_GetCharacterID_ReturnValue;               // 0x02DC(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetIsTowerBoss_ReturnValue;               // 0x02E4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetIsRaidBoss_ReturnValue;                // 0x02E5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail) == 0x0002E8, "Wrong size on WBP_IngameBossHP_C_Set_Enable_Talent_Detail");
...
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_IsValid_ReturnValue) == 0x0002D8, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetCharacterID_ReturnValue) == 0x0002DC, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetCharacterID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetIsTowerBoss_ReturnValue) == 0x0002E4, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetIsTowerBoss_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetIsRaidBoss_ReturnValue) == 0x0002E5, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetIsRaidBoss_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_BooleanOR_ReturnValue) == 0x0002E6, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2623[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2624[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
