...
public:
	...
	uint8                                         Pad_13DF[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_13E0[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_13E1[0x88];                                    // 0x0000(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_13E2[0x38];                                    // 0x0090(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_13E4[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
