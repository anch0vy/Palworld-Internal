...
static_assert(offsetof(ALI_MonsterPhysics_C_MonsterPhysics, Param_MonsterPhysics) == 0x000010, "Member 'ALI_MonsterPhysics_C_MonsterPhysics::Param_MonsterPhysics' has a wrong offset!");
