...
public:
	...
	uint8                                         Pad_5B8E[0x7];                                     // 0x03F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5B8F[0x3];                                     // 0x0411(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnHitDelegate______0(class UPrimitiveComponent* MyHitComponent, class AActor* OtherHitActor, class UPrimitiveComponent* OtherHitComponent, const TArray<int32>& FoliageIndex, const struct FVector& HitLocation, int32 HitCount);
	void OnBreakAction();
