...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_PumpActionShotgun_C;             // 0x05A0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_PumpActionShotgun_C) == 0x0005A8, "Wrong size on ABP_PumpActionShotgun_C");
static_assert(offsetof(ABP_PumpActionShotgun_C, UberGraphFrame_BP_PumpActionShotgun_C) == 0x0005A0, "Member 'ABP_PumpActionShotgun_C::UberGraphFrame_BP_PumpActionShotgun_C' has a wrong offset!");
