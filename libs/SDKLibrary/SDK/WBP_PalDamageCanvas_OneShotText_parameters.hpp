...
public:
	...
	uint8                                         Pad_3E8A[0x4];                                     // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E8B[0x6];                                     // 0x0102(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E8C[0x7];                                     // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E8D[0x7];                                     // 0x0139(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E8E[0x2];                                     // 0x00F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E8F[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E90[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E91[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E92[0x3];                                     // 0x0105(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E93[0x3];                                     // 0x0119(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalOptionUISettings                   CallFunc_GetUISettings_ReturnValue;                // 0x011C(0x0018)(ConstParm, NoDestructor)
	TDelegate<void(struct FPalOptionUISettings& PrevSettings, struct FPalOptionUISettings& NewSettings)> K2Node_CreateDelegate_OutputDelegate;              // 0x0134(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(struct FPalDamageInfo& DamageInfo, class AActor* Defender)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0144(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3E94[0x4];                                     // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E95[0x3];                                     // 0x0161(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_PalDamageCanvas_OneShotText_C_ExecuteUbergraph_WBP_PalDamageCanvas_OneShotText, K2Node_CreateDelegate_OutputDelegate) == 0x000134, "Member 'WBP_PalDamageCanvas_OneShotText_C_ExecuteUbergraph_WBP_PalDamageCanvas_OneShotText::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_PalDamageCanvas_OneShotText_C_ExecuteUbergraph_WBP_PalDamageCanvas_OneShotText, K2Node_CreateDelegate_OutputDelegate_1) == 0x000144, "Member 'WBP_PalDamageCanvas_OneShotText_C_ExecuteUbergraph_WBP_PalDamageCanvas_OneShotText::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3E96[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3E97[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	double                                        K2Node_VariableSet_DamageTextScale_ImplicitCast;   // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings) == 0x000038, "Wrong size on WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings");
...
static_assert(offsetof(WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings, NewSettings) == 0x000018, "Member 'WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings::NewSettings' has a wrong offset!");
static_assert(offsetof(WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings, K2Node_VariableSet_DamageTextScale_ImplicitCast) == 0x000030, "Member 'WBP_PalDamageCanvas_OneShotText_C_OnChangedUISettings::K2Node_VariableSet_DamageTextScale_ImplicitCast' has a wrong offset!");
