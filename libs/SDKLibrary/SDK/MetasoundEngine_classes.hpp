...
{
public:
	uint8                                         Pad_25AC[0x68];                                    // 0x04A0(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25AD[0x3];                                     // 0x07C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25AE[0xC];                                     // 0x07D4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_25AF[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25B0[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25B1[0x4];                                     // 0x007C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_25B2[0x68];                                    // 0x0028(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_25B3[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25B4[0x198];                                   // 0x0048(0x0198)(Fixing Struct Size After Last Property [ Dumper-7 ])
